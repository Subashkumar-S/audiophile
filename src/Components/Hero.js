...
const Hero = () => {
  return (
    <section className='bg-home-mobile sm:bg-home-tablet lg:bg-home-desktop bg-cover bg-center bg-no-repeat w-full h-[70vh] md:h-screen  text-white '>
      <Navbar />
    <div className='flex items-center justify-center lg:justify-start px-[13vw] absolute top-[20vh] md:top-[40vh]'>
